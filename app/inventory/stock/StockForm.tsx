...
import { TextInput, NumberInput, FormError, FormActions } from "@/components/form";
    ...
    <form action={formAction} className="mx-auto max-w-2xl">
      <Card className="space-y-4 p-5">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <NumberInput name="opening_stock" label="Opening (t)" required defaultValue={defaults.opening_stock} error={err.opening_stock} />
          <NumberInput name="produced" label="Produced (t)" defaultValue={defaults.produced} error={err.produced} />
          <NumberInput name="purchased" label="Purchased (t)" defaultValue={defaults.purchased} error={err.purchased} />
          <NumberInput name="delivered" label="Out / delivered (t)" defaultValue={defaults.delivered} error={err.delivered} />
          <NumberInput name="safety_stock_level" label="Safety level (t)" defaultValue={defaults.safety_stock_level} hint="Default 20" error={err.safety_stock_level} />
        </div>
