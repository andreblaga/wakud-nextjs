...
- **Roles + RLS hardening ✅ (2026-08-13; 1 migration to run)** — implements the P0 RLS item and the P1 access items from `docs/go-live-plan.md` in one pass.
  ...
  - **Still open:** P1 auth hardening (self-serve password reset, email confirmation, session timeout) was not part of this pass. Until it lands, a forgotten password means an admin resets it here or in the dashboard.
